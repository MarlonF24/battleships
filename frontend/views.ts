...
export function createGridElement(grid: Grid) {
...
export function createShipElement(
    ship: Ship,
    cellSize: number,
    src: "battle",
...
export function createShipElement(
    ...
    if (src === "battle") {
        ...
        el.style.left = `${(position.col ?? 0) * cellSize}px`;
...
export function renderView(grid: BattleGrid, container: HTMLElement): void {
...
export function renderGarage(garage: ShipGarage, container: HTMLElement): void {
